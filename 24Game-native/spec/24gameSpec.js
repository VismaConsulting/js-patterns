(function(visma, describe, it, expect){
    ...
    describe("Game suite", function () {
        ...
        it("should eval the answer to 24", function () {
            expect(visma.game.verifyAnswer([
                new visma.Card("", 9),
                new visma.Card("", 2),
                new visma.Card("", 4),
                new visma.Card("", 1)], "4 + (9 +1)*2")).toBe(true);
        });
        ...
        it("should eval the answer and it should not be 24", function () {
            expect(visma.game.verifyAnswer([
                ...
                new visma.Card("", 2),
                new visma.Card("", 4),
                new visma.Card("", 2)], "4 + (9 +2)*2")).toBe(false);
        });

        it("should cast fault if were missing a number in the answer", function () {
            expect(function () {
                visma.game.verifyAnswer([
                    new visma.Card("", 9),
                    new visma.Card("", 2),
                    new visma.Card("", 4),
                    new visma.Card("", 2)], "4 + (9 +2)");
